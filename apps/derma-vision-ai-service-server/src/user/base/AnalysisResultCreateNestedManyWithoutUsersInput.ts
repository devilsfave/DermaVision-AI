...
@InputType()
class AnalysisResultCreateNestedManyWithoutUsersInput {
...
export { AnalysisResultCreateNestedManyWithoutUsersInput as AnalysisResultCreateNestedManyWithoutUsersInput };
