...
@InputType()
class ConsultationCreateNestedManyWithoutAnalysisResultsInput {
...
export { ConsultationCreateNestedManyWithoutAnalysisResultsInput as ConsultationCreateNestedManyWithoutAnalysisResultsInput };
