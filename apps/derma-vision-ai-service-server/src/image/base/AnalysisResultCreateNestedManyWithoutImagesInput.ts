...
@InputType()
class AnalysisResultCreateNestedManyWithoutImagesInput {
...
export { AnalysisResultCreateNestedManyWithoutImagesInput as AnalysisResultCreateNestedManyWithoutImagesInput };
